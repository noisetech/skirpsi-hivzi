        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    ...
                    <a href="{{ route('byfutsal') }}" class="btn btn-sm btn-secondary">Futsal</a>
                    <a href="{{ route('bybulutangkis') }}" class="btn btn-sm btn-danger">Bulu Tangkis</a>
                    <a href="{{ route('bybasket') }}" class="btn btn-sm btn-warning">Basket</a>
                    <a href="{{ route('byrate') }}" class="btn btn-sm btn-primary">Rate</a>
                    </div><!-- /.col -->
